...
env = gymnasium.make("UniversalPosTagging-v5", sentences=train_sentences, tags=train_tags)
...
class DQNAgent:
    def __init__(self):
        ...
        self.loss_function = keras.losses.Huber() # Huber handles outliers like -5.0 gently
...
def run_test_suite():
    ...
    test_cases = [
        # 1. Standard Sentence (Baseline)
        "The computer computes the result",
        
        # 2. Ambiguity: "Book" as Verb vs Noun
        "I will book the flight",
        "The book is on the table",
        
        # 3. Ambiguity: "Run" as Noun vs Verb
        "The run was long and tiring",
        "They run very fast",
        
        # 4. Morphology / OOV Test (Made up words)
        # "Gloober" (ends in -er -> Noun)
        # "Jumping" (ends in -ing -> Verb)
        # "Lazily" (ends in -ly -> Adverb)
        "The gloober is jumping lazily",
        
        # 5. Adjective Chain (Can it handle multiple ADJs?)
        "The big red quick fox jumped",
        
        # 6. Complex Structure with Prepositions
        "The cat slept under the warm blanket",
        
        # 7. Common Mistake: "Her" (Pronoun vs Determiner)
        "I like her cooking",
        "Give it to her"
    ]
